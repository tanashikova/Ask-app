...
from . import views
from .views import QuestionListView, QuestionDetailView, QuestionCreateView,  QuestionUpdateView, QuestionDeleteView, AddAnswerView, AnswerDeleteView, LikeView
...
urlpatterns = [
     ...
     path('like/<int:pk>', LikeView, name='question-like'),
